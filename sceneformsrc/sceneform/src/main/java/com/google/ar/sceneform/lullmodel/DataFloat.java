...
public final class DataFloat extends Table {
  public static DataFloat getRootAsDataFloat(ByteBuffer _bb) {
    return getRootAsDataFloat(_bb, new DataFloat());
  }

  public static DataFloat getRootAsDataFloat(ByteBuffer _bb, DataFloat obj) {
  ...
  public DataFloat __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
