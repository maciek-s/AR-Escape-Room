...
public final class ModelDef extends Table {
  public static ModelDef getRootAsModelDef(ByteBuffer _bb) {
    return getRootAsModelDef(_bb, new ModelDef());
  }

  public static ModelDef getRootAsModelDef(ByteBuffer _bb, ModelDef obj) {
  ...
  public ModelDef __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public ModelInstanceDef lods(int j) {
    return lods(new ModelInstanceDef(), j);
  }
  ...
  public AabbDef boundingBox(AabbDef obj) {
    int o = __offset(10);
