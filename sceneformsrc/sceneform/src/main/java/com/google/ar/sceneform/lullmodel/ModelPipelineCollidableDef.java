...
public final class ModelPipelineCollidableDef extends Table {
  public static ModelPipelineCollidableDef getRootAsModelPipelineCollidableDef(ByteBuffer _bb) {
    return getRootAsModelPipelineCollidableDef(_bb, new ModelPipelineCollidableDef());
  }

  public static ModelPipelineCollidableDef getRootAsModelPipelineCollidableDef(ByteBuffer _bb, ModelPipelineCollidableDef obj) {
  ...
  public ModelPipelineCollidableDef __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
