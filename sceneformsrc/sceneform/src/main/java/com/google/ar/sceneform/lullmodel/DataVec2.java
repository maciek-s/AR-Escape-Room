...
public final class DataVec2 extends Table {
  public static DataVec2 getRootAsDataVec2(ByteBuffer _bb) {
    return getRootAsDataVec2(_bb, new DataVec2());
  }

  public static DataVec2 getRootAsDataVec2(ByteBuffer _bb, DataVec2 obj) {
  ...
  public DataVec2 __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
