...
public final class VariantMapDef extends Table {
  public static VariantMapDef getRootAsVariantMapDef(ByteBuffer _bb) {
    return getRootAsVariantMapDef(_bb, new VariantMapDef());
  }

  public static VariantMapDef getRootAsVariantMapDef(ByteBuffer _bb, VariantMapDef obj) {
  ...
  public VariantMapDef __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }

  public KeyVariantPairDef values(int j) {
    return values(new KeyVariantPairDef(), j);
  }
