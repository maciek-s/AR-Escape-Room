...
public final class DataString extends Table {
  public static DataString getRootAsDataString(ByteBuffer _bb) {
    return getRootAsDataString(_bb, new DataString());
  }

  public static DataString getRootAsDataString(ByteBuffer _bb, DataString obj) {
  ...
  public DataString __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
