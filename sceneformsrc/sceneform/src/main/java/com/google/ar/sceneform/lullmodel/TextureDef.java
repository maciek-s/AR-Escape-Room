...
public final class TextureDef extends Table {
  public static TextureDef getRootAsTextureDef(ByteBuffer _bb) {
    return getRootAsTextureDef(_bb, new TextureDef());
  }

  public static TextureDef getRootAsTextureDef(ByteBuffer _bb, TextureDef obj) {
  ...
  public TextureDef __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public int minFilter() {
    int o = __offset(14);
    return o != 0 ? bb.getShort(o + bb_pos) & 0xFFFF : 4;
  }

  public int magFilter() {
    int o = __offset(16);
    return o != 0 ? bb.getShort(o + bb_pos) & 0xFFFF : 1;
  }
