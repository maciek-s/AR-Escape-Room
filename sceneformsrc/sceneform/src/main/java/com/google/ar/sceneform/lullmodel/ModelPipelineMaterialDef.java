...
public final class ModelPipelineMaterialDef extends Table {
  public static ModelPipelineMaterialDef getRootAsModelPipelineMaterialDef(ByteBuffer _bb) {
    return getRootAsModelPipelineMaterialDef(_bb, new ModelPipelineMaterialDef());
  }

  public static ModelPipelineMaterialDef getRootAsModelPipelineMaterialDef(ByteBuffer _bb, ModelPipelineMaterialDef obj) {
  ...
  public ModelPipelineMaterialDef __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
