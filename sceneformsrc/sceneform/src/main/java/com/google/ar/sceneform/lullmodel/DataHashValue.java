...
public final class DataHashValue extends Table {
  public static DataHashValue getRootAsDataHashValue(ByteBuffer _bb) {
    return getRootAsDataHashValue(_bb, new DataHashValue());
  }

  public static DataHashValue getRootAsDataHashValue(ByteBuffer _bb, DataHashValue obj) {
  ...
  public DataHashValue __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
