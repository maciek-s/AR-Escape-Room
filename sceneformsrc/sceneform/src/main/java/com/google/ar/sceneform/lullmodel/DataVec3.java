...
public final class DataVec3 extends Table {
  public static DataVec3 getRootAsDataVec3(ByteBuffer _bb) {
    return getRootAsDataVec3(_bb, new DataVec3());
  }

  public static DataVec3 getRootAsDataVec3(ByteBuffer _bb, DataVec3 obj) {
  ...
  public DataVec3 __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
