...
public final class MaterialTextureDef extends Table {
  public static MaterialTextureDef getRootAsMaterialTextureDef(ByteBuffer _bb) {
    return getRootAsMaterialTextureDef(_bb, new MaterialTextureDef());
  }

  public static MaterialTextureDef getRootAsMaterialTextureDef(ByteBuffer _bb, MaterialTextureDef obj) {
  ...
  public MaterialTextureDef __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
