...
public final class SubmeshAabb extends Table {
  public static SubmeshAabb getRootAsSubmeshAabb(ByteBuffer _bb) {
    return getRootAsSubmeshAabb(_bb, new SubmeshAabb());
  }

  public static SubmeshAabb getRootAsSubmeshAabb(ByteBuffer _bb, SubmeshAabb obj) {
  ...
  public SubmeshAabb __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
