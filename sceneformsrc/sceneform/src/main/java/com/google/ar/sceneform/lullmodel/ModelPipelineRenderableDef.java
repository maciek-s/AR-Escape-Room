...
public final class ModelPipelineRenderableDef extends Table {
  public static ModelPipelineRenderableDef getRootAsModelPipelineRenderableDef(ByteBuffer _bb) {
    return getRootAsModelPipelineRenderableDef(_bb, new ModelPipelineRenderableDef());
  }

  public static ModelPipelineRenderableDef getRootAsModelPipelineRenderableDef(ByteBuffer _bb, ModelPipelineRenderableDef obj) {
  ...
  public ModelPipelineRenderableDef __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public ModelPipelineMaterialDef materials(int j) {
    return materials(new ModelPipelineMaterialDef(), j);
  }
