...
public final class ModelPipelineImportDef extends Table {
  public static ModelPipelineImportDef getRootAsModelPipelineImportDef(ByteBuffer _bb) {
    return getRootAsModelPipelineImportDef(_bb, new ModelPipelineImportDef());
  }

  public static ModelPipelineImportDef getRootAsModelPipelineImportDef(ByteBuffer _bb, ModelPipelineImportDef obj) {
  ...
  public static void addSmoothingAngle(FlatBufferBuilder builder, float smoothingAngle) {
    builder.addFloat(5, smoothingAngle, 45.0f);
  }
  ...
  public static void addCmPerUnit(FlatBufferBuilder builder, float cmPerUnit) {
    builder.addFloat(13, cmPerUnit, 0.0f);
  }
  ...
  public ModelPipelineImportDef __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public float smoothingAngle() {
    int o = __offset(14);
    return o != 0 ? bb.getFloat(o + bb_pos) : 45.0f;
  }
