...
public final class ModelPipelineDef extends Table {
  public static ModelPipelineDef getRootAsModelPipelineDef(ByteBuffer _bb) {
    return getRootAsModelPipelineDef(_bb, new ModelPipelineDef());
  }

  public static ModelPipelineDef getRootAsModelPipelineDef(ByteBuffer _bb, ModelPipelineDef obj) {
  ...
  public ModelPipelineDef __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public ModelPipelineImportDef sources(int j) {
    return sources(new ModelPipelineImportDef(), j);
  }
  ...
  public ModelPipelineRenderableDef renderables(int j) {
    return renderables(new ModelPipelineRenderableDef(), j);
  }
  ...
  public TextureDef textures(int j) {
    return textures(new TextureDef(), j);
  }
