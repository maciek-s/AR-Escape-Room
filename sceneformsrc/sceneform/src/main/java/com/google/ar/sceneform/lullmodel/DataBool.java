...
public final class DataBool extends Table {
  public static DataBool getRootAsDataBool(ByteBuffer _bb) {
    return getRootAsDataBool(_bb, new DataBool());
  }

  public static DataBool getRootAsDataBool(ByteBuffer _bb, DataBool obj) {
  ...
  public DataBool __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
