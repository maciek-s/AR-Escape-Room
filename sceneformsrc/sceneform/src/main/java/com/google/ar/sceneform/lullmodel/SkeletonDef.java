...
public final class SkeletonDef extends Table {
  public static SkeletonDef getRootAsSkeletonDef(ByteBuffer _bb) {
    return getRootAsSkeletonDef(_bb, new SkeletonDef());
  }

  public static SkeletonDef getRootAsSkeletonDef(ByteBuffer _bb, SkeletonDef obj) {
  ...
  public static int createBoneParentsVector(FlatBufferBuilder builder, ByteBuffer data) {
    return builder.createByteVector(data);
  }
  ...
  public SkeletonDef __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public ByteBuffer boneParentsInByteBuffer(ByteBuffer _bb) {
  ...
  public Mat4x3 boneTransforms(int j) {
    return boneTransforms(new Mat4x3(), j);
  }

  public Mat4x3 boneTransforms(Mat4x3 obj, int j) {
    int o = __offset(8);
