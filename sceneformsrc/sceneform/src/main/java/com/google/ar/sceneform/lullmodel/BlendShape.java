...
public final class BlendShape extends Table {
  public static BlendShape getRootAsBlendShape(ByteBuffer _bb) {
  ...
  public static void addName(FlatBufferBuilder builder, long name) {
    builder.addInt(0, (int) name, (int) 0L);
  }
  ...
  public static int createTangentDataVector(FlatBufferBuilder builder, ByteBuffer data) {
    return builder.createByteVector(data);
  }
  ...
  public BlendShape __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public ByteBuffer tangentDataInByteBuffer(ByteBuffer _bb) {
