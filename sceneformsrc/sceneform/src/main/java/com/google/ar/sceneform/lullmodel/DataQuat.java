...
public final class DataQuat extends Table {
  public static DataQuat getRootAsDataQuat(ByteBuffer _bb) {
    return getRootAsDataQuat(_bb, new DataQuat());
  }

  public static DataQuat getRootAsDataQuat(ByteBuffer _bb, DataQuat obj) {
  ...
  public DataQuat __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
